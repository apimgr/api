...
func parseLogLine(line string) LogEntry {
	...
	// Layouts are variable-width once a timezone offset is replaced by "Z"
	// (RFC3339 shrinks from 25 to 20 chars), so try decreasing prefix
	// lengths rather than a single fixed-width slice per layout.
parseTimestamp:
